# Clario AML/KYT Policy — Crypto / VASP v1.2

**Jurisdiction:** crypto  
**Version:** v1.2  
**Scope:** VASP withdrawals, deposits, Travel Rule, on-chain graph
...
- Structuring / smurfing band ($9,000–$9,999)
...
- OFAC SDN adjacency (direct or 1–2 hop) → hard ESCALATE
- Incomplete IVMS101 on high-value VASP transfer → hard ESCALATE
